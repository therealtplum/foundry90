...
- `KALSHI_INTEGRATION_SUMMARY.md` - **This document** (comprehensive overview)
- `KALSHI_PROTOCOL.md` - Protocol reference (authentication, message formats)
- `KALSHI_INTEGRATION_COMPLETE.md` - Integration completion summary
- `KALSHI_TICKER_PARSER_PHASE1_COMPLETE.md` - Phase 1 parser completion
- `KALSHI_INSTRUMENT_NORMALIZATION_PROPOSAL.md` - Original proposal (reference)
- `status_and_roadmap.md` - Overall Hadron status and roadmap
- `polygon_plan_limitations.md` - Polygon API plan details
...
- `apps/hadron/docs/KALSHI_PROTOCOL.md` - Protocol details
- `apps/hadron/docs/status_and_roadmap.md` - Overall roadmap
...
4. **Troubleshoot**: See `KALSHI_PROTOCOL.md` for common issues
