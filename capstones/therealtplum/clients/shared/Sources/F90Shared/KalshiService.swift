...
public protocol KalshiServiceType {
...
public struct KalshiService: KalshiServiceType {
    public let baseURL: URL
    
    public static let defaultBaseURL = URL(string: "http://127.0.0.1:3000")!
    
    public init(baseURL: URL = KalshiService.defaultBaseURL) {
        self.baseURL = baseURL
    }
    
    // MARK: - Markets
    
    public func fetchMarkets(category: String? = nil, status: String? = nil, limit: Int? = nil, offset: Int? = nil, search: String? = nil) async throws -> [KalshiMarketSummary] {
    ...
    public func fetchMarket(ticker: String) async throws -> KalshiMarketDetail {
    ...
    public func fetchUserAccount(userId: String) async throws -> KalshiUserAccount {
    ...
    public func fetchUserBalance(userId: String) async throws -> KalshiUserBalance {
    ...
    public func fetchUserPositions(userId: String) async throws -> [KalshiPosition] {
    ...
    public func storeCredentials(userId: String, apiKey: String, apiSecret: String) async throws -> Bool {
